import { Faculty, SurveyRow, IntakeConfig, User } from './types';
...
export const intakeConfig: IntakeConfig = {
  ...
  announcementText: "การรับสมัครนักศึกษา ภาคการศึกษาที่ 2/2568 เปิดรับสมัครตั้งแต่วันที่ 1 ธ.ค. 2567 - 28 ก.พ. 2568",
  status: "open"
};
    ...
    departments: [
      {
        ...
        programs: [
          { id: "cpe-bachelor", name: "วิศวกรรมศาสตรบัณฑิต (วิศวกรรมคอมพิวเตอร์)", open: true },
          { id: "cpe-master", name: "วิศวกรรมศาสตรมหาบัณฑิต (วิศวกรรมคอมพิวเตอร์)", open: true }
        ]
      },
      {
        id: "ee",
        ...
        programs: [
          { id: "ee-bachelor", name: "วิศวกรรมศาสตรบัณฑิต (วิศวกรรมไฟฟ้า)", open: true },
          { id: "ee-master", name: "วิศวกรรมศาสตรมหาบัณฑิต (วิศวกรรมไฟฟ้า)", open: false }
        ]
      },
      {
        id: "me",
        ...
        programs: [
          { id: "me-bachelor", name: "วิศวกรรมศาสตรบัณฑิต (วิศวกรรมเครื่องกล)", open: true }
        ]
      }
    ]
  },
    ...
    departments: [
      {
        ...
        programs: [
          { id: "math-bachelor", name: "วิทยาศาสตรบัณฑิต (คณิตศาสตร์)", open: true },
          { id: "math-master", name: "วิทยาศาสตรมหาบัณฑิต (คณิตศาสตร์)", open: true }
        ]
      },
      {
        id: "chem",
