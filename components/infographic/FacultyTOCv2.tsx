...
export const DEFAULT_FACULTY_TOC_CONTENT_V2: FacultyTOCContent = {
  leftTitleLine1: "เกณฑ์การรับสมัครนักศึกษา",
  leftTitleLine2: "รอบที่ 2 (ปีการศึกษา 2569)",
  bannerText: "โครงการ Active Recruitment",
...
export function FacultyTOCv2({ data, content, logoUrl = '/ICON.png', footerLogoUrl = '/ICON.png' }: Props) {
  const tocContent = { ...DEFAULT_FACULTY_TOC_CONTENT_V2, ...content };
  ...
  return (
    <div
      ...
      <div
        ...
        <div
          className="flex-1 flex items-center justify-center text-white font-bold px-6 text-center"
          style={{
