...
interface InfographicTopHeaderV2Props {
    className?: string;
    style?: CSSProperties;
...
const DEFAULT_BANNER_TEXT = 'โครงการ Active Recruitment';

export function InfographicTopHeaderV2({
    className,
    style,
